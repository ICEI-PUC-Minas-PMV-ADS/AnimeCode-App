...
const Profile = () => {
  ...
  const user_id = id;
  // const [animeName, setAnimeName] = ;
  const [imgUrl, setImgUrl] = useState();
  const [listId, setListId] = useState();
  const [nameAnimeModal, setNameAnimeModal] = useState();
  ...
  const updateInfoUserAnime = () => {
    updateProgressAnime(listId, {
      ...
      anime_id: anime_id,
      user_id: user_id,
      anime_name: nameAnimeModal,
      imageAnime_url: imgUrl,
      seasons: seasons,
      episodes: episodes,
    }).then((res) => {
      console.log(res);
  ...
  useEffect(() => {
    searchUserListAnime(user_id).then((res) => {
      setDataUser(res);
    });
  }, []);
              ...
              <Pressable
                onPress={() =>
                  setModalVisible(
                    true,
                    setListId(el.id),
                    setNameAnimeModal(el.anime_name),
                    setImgUrl(el.imageAnime_url)
                  )
                }>
                {({ pressed }) => (
                  <Image
            ...
            <Modal
              ...
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  ...
                  <Text style={styles.modalText}>{nameAnimeModal}</Text>
                  ...
                  <Input
                    ...
                    style={styles.input}
                    value={episodes}
                    onChangeText={(number) => setEpisodes(number)}
                  />
                  ...
                  <Input
                    style={styles.input}
                    value={seasons}
                    onChangeText={(number) => setSeasons(number)}
                  />
                  <Pressable
